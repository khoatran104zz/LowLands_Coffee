...
export const INITIAL_CATEGORIES: Category[] = [
  { id: 1, name: "Cà Phê", description: "Cà phê phin truyền thống hảo hạng từ Tây Nguyên", status: "active" },
  { id: 2, name: "Trà", description: "Các dòng trà trái cây thanh mát, giải nhiệt", status: "active" },
  { id: 3, name: "Freeze", description: "Đá xay mát lạnh, béo ngậy kèm kem tươi", status: "active" },
  { id: 4, name: "Khác", description: "Các loại bánh ngọt và bánh mì ăn kèm", status: "active" }
];
