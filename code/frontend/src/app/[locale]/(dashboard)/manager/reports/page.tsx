        ...
        <ChartCard title="Tổng kết vận hành hôm nay">
          <div className="space-y-3.5 text-xs font-semibold text-zinc-700 mt-2">
            ...
            <div className="flex justify-between pt-1">
              <span className="text-[#948175] font-bold select-none uppercase text-[10px]">Tong doanh thu quay ghi nhan:</span>
              <span className="text-amber-900 font-extrabold text-sm">
                {myBranchOrders.filter(o => o.status === "completed").reduce((sum, o) => sum + o.totalAmount, 0).toLocaleString("vi-VN")}??
              </span>
            </div>
          </div>
        </ChartCard>
